...
export function ShaderAnimation() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.log('WebGL error, using fallback:', e)
      setWebGLSupported(false)
      return
    }

    if (useReducedMotion) {
      console.log('Reduced motion detected, using fallback')
      return
    }
  ...
  // Static fallback for reduced motion or unsupported WebGL
  if (useReducedMotion || !webGLSupported) {
    return (
      <div
        ...
        style={{
          background: `
            ...
            linear-gradient(135deg, rgba(0, 0, 0, 1) 0%, rgba(15, 23, 42, 1) 100%)
          `,
          zIndex: 0
        }}
      />
